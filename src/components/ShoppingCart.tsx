...
const ShoppingCart = ({ cartOpened }: { cartOpened: boolean }) => {
  ...
  return (
    <>
      <div
        className="shopping-cart-connector"
        style={{ display: cartOpened ? 'block' : 'none' }}
      >
        <svg
          width="24"
          height="24"
          fill="none"
          viewBox="0 0 24 24"
          style={{ position: 'absolute', left: '-24px', bottom: '0' }}
        >
          <path
            fill="#fff"
            fillRule="evenodd"
            d="M 0.01 24 H 24 V 0.01 C 23.995 13.257 13.257 23.995 0.01 24 Z"
            clipRule="evenodd"
          ></path>
        </svg>
      </div>
